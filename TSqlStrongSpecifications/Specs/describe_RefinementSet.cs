...
#pragma warning disable IDE1006 // Naming Styles
    class describe_RefinementSet : NSpec.nspec
    {
        ...
        public void describe_Conjunction()
        {
            ...
            WhenTakingConjunction(
                of: RefinementSet.From(("x", SqlDataTypeWithKnownSet.IntExclude(1, 2))),
                with: RefinementSet.From(("x", SqlDataTypeWithKnownSet.IntExclude(3, 4))),
                itProduces: Refinement.FromVariableNames(("x", SqlDataTypeWithKnownSet.IntExclude(1, 2, 3, 4)))
            );

            WhenTakingConjunction(
                of: RefinementSet.From(("x", SqlDataTypeWithKnownSet.Int(1, 2))),
                with: RefinementSet.From(("x", SqlDataTypeWithKnownSet.Int(3, 4))),
                itProduces: Refinement.FromVariableNames()
            );
        ...
        public void describe_Disjunction()
        {
            ...
            WhenTakingDisjunction(
                of: RefinementSet.From(
                    ...
                    ("x", SqlDataTypeWithKnownSet.Int(1, 2))
                ),
                with: RefinementSet.Empty,
                itProduces: Refinement.FromVariableNames()                
            );
            ...
            WhenTakingDisjunction(
                of: RefinementSet.From(("x", SqlDataTypeWithKnownSet.Int(1, 2))),
                with: RefinementSet.From(("x", new NullableDataType(SqlDataTypeWithKnownSet.Int(3, 4)))),
                itProduces: Refinement.FromVariableNames(("x", new NullableDataType(SqlDataTypeWithKnownSet.Int(1, 2, 3, 4))))
            );
        }
